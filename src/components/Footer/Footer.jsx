          ...
          <section>
            ...
            <ul className="nav flex-column">
              <li className="nav-item">
                <NavLink to="/bosa-noga/about" className="nav-link">О магазине</NavLink>
              </li>
              <li className="nav-item">
                <NavLink to="/bosa-noga/catalog" className="nav-link">Каталог</NavLink>
              </li>
              <li className="nav-item">
                <NavLink to="/bosa-noga/contacts" className="nav-link">Контакты</NavLink>
              </li>
            </ul>
          </section>
        </div>
